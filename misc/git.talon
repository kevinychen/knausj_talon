...
git clean everything: "git clean -dffx"
git commit message <user.text>: "git commit -m '{text}'"
git commit: "git commit\n"
git commit amend: "git commit --amend\n"
git commit amend sign: "git commit --amend -S\n"
git commit amend existing: "git commit --amend -a\n"
git commit amend existing sign: "git commit --amend -aS\n"
git commit sign: "git commit -S\n"
git commit no verify: "git commit -n"
git commit existing: "git commit -a\n"
git commit existing sign: "git commit -aS\n"
